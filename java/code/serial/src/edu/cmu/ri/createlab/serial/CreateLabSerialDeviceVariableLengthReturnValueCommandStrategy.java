...
public abstract class CreateLabSerialDeviceVariableLengthReturnValueCommandStrategy<DesiredClass> extends CreateLabSerialDeviceCommandStrategy implements SerialDeviceReturnValueCommandStrategy<DesiredClass>
   ...
   /**
    * Creates a <code>CreateLabSerialDeviceVariableLengthReturnValueCommandStrategy</code> using the default values for read timeout, slurp
   ...
   /**
    * Creates a <code>CreateLabSerialDeviceVariableLengthReturnValueCommandStrategy</code> using the given value for read timeout and the default
   ...
   /**
    * Creates a <code>CreateLabSerialDeviceVariableLengthReturnValueCommandStrategy</code> using the given values for read timeout, slurp
    * timeout, and max retries.
    *
    ...
    * @see #DEFAULT_MAX_NUMBER_OF_RETRIES
    */
   protected CreateLabSerialDeviceVariableLengthReturnValueCommandStrategy(final long readTimeout, final TimeUnit readTimeoutTimeUnit)
      {
      super(readTimeout, readTimeoutTimeUnit);
      }

   /**
    * Creates a <code>CreateLabSerialDeviceVariableLengthReturnValueCommandStrategy</code> using the given values for read timeout and slurp
    * timeout and the default value for max retries.
    *
    * @see #DEFAULT_MAX_NUMBER_OF_RETRIES
    */
   protected CreateLabSerialDeviceVariableLengthReturnValueCommandStrategy(final long readTimeout, final TimeUnit readTimeoutTimeUnit, final long slurpTimeout, final TimeUnit slurpTimeoutTimeUnit)
      {
    ...
    * timeout, and max retries.
    */
   protected CreateLabSerialDeviceVariableLengthReturnValueCommandStrategy(final long readTimeout, final TimeUnit readTimeoutTimeUnit, final long slurpTimeout, final TimeUnit slurpTimeoutTimeUnit, final int maxNumberOfRetries)
      {
